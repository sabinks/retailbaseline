...
class ClientReportDataExport implements FromCollection, ShouldAutoSize, WithEvents
{
    public $all_data, $id;
    ...
    public function collection(){
        ...
        $report_excel[0] = ['Entity Name', 'Latitude', 'Latitude', 'Region Name', 'Filled Date', 'Status'];
        $formInputLabel = [];
        $formInputs = [];
        ...
        foreach ($all_reports_data as $report) {
            ...
            $data = [
                ...
                $report->entities->latitude,
                $report->entities->longitude, 
                $report->region->name,
                $report->filled_date ? $report->filled_date : '-', 
