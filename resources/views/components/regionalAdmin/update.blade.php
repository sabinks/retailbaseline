...
<div class="main-card mb-3 card">
    ...
    <div class="card-body">
        <form method="post" action="{{route('regionalAdmins.update',$user->id)}}" enctype="multipart/form-data" onsubmit="return checkForm(this);">
        @csrf
        @method('put')
            <div class="row">
            ...
            <div class='row'>
                <div class='form-group col-12 mb-0'>
                    ...
                    href="{{route('regionalAdmins.index')}}"> Cancel<a></button>
                </div>
            </div>
        </form>
