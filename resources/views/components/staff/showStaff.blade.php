...
<div class="main-card mb-3 card">
    ...
    <div class="card-body">
    <h5 style="text-align:center">Information of Field Staff</h5>
    <a title="back" href="{{URL::previous()}}"><i class="material-icons">arrow_back</i></a>
        ...
        {{-- <div class="row">
            <div class="col-md-12">
                <h4>Field Staff Record's History</h4>
            </div>
        </div> --}}
    </div>
</div>
