...
<div class="main-card mb-3 card">
    ...
    @endif
    <div class="card-body">
        <form method="post" action="{{asset('remove_staff/'.$user->id)}}">
            <h5>Available Field Staffs Names || select one or more</h5>
            @csrf
            <div class="form-group">
                <label for="sel2">Only staffs ,those are granted by you, can be remove. Field staffs created by him and his lower manager can not be remove.</label>
