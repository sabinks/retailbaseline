...
const ReportUpdate = () => {
    ...
    useEffect(() => {
        let id = window.location.pathname.replace('/super/report-form/update/', '')
    ...
    const handleClickSave = (event) => {
        ...
        axios.put(`/superadmin/report-form/${state.id}`, input)
            .then(res => {
    ...
    return (
        <div>
            ...
            <Link className='btn btn-secondary pull-right mr-3' to={'/super/report-data/list'}>
                Cancel
            </Link>
